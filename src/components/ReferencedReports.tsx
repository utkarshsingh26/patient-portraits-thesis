...
//   return (
//     <Box sx={{ height: "100%", width: "100%", bgcolor: "#FFFAFA", display: "flex", justifyContent: "center", alignContent: "center", flexDirection: "column", borderRadius: "5px", boxShadow: 3, p: 2, alignItems: "center" }}>
//       {/* Title */}
// <Typography sx={{ display: "inline-block", fontWeight: "bold", "color": "black", marginLeft: -42, marginTop: -35, fontSize: 20, textShadow: "2px 2px 4px rgba(0, 0, 0, 0.2)"}}> Reports Referenced </Typography>
...
//               variant="body1"
//               component="pre"
//               sx={{ whiteSpace: "pre-wrap", overflow: "auto", height: "100%"}}
//             >
//               {renderHighlightedText(highlightedText)}
//             </Typography>
//           </Paper>
